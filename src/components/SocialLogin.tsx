...
export default function SocialLogin(){
    return (
        <Box mb={4}>
            ...
            <VStack>
                <Button as="a" href="https://github.com/login/oauth/authorize?client_id=7295d1136e095e687640&scope=read:user,user:email" w="100%" leftIcon={<FaGithub />}>Continue with Github</Button>
